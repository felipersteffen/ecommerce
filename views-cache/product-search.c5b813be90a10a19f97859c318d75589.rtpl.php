    ...
    <div class="row row-cols-1 row-cols-md-4 g-4">
        ...
        <div class="col">
            <div class="card border-dark h-100">
                ...
                <div class="card-body">
                    <h6 class="card-title"><strong><?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong></h6>
                    <p class="card-subtitle mb-2 text-body-secondary">Categories: <?php echo htmlspecialchars( $value1["categories"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
